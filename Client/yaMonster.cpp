...
namespace ya
{
	...
	void Monster::Hit(int _dir)
	{
		...
		if (Chapter6* chpt6 = dynamic_cast<Chapter6*>(scene))
		{
			...
			{
			case 0:
				ObjectInfo = chpt6->MapInfo6[MonsterY - 1][MonsterX];
				break;
			case 1:
				ObjectInfo = chpt6->MapInfo6[MonsterY + 1][MonsterX];
				break;
			case 2:
				ObjectInfo = chpt6->MapInfo6[MonsterY][MonsterX - 1];
				break;
			case 3:
				ObjectInfo = chpt6->MapInfo6[MonsterY][MonsterX + 1];
				break;
		...
		if (Chapter7* chpt7 = dynamic_cast<Chapter7*>(scene))
		{
			...
			{
			case 0:
				ObjectInfo = chpt7->MapInfo7[MonsterY - 1][MonsterX];
				break;
			case 1:
				ObjectInfo = chpt7->MapInfo7[MonsterY + 1][MonsterX];
				break;
			case 2:
				ObjectInfo = chpt7->MapInfo7[MonsterY][MonsterX - 1];
				break;
			case 3:
				ObjectInfo = chpt7->MapInfo7[MonsterY][MonsterX + 1];
				break;
		...
		if (Chapter8* chpt8 = dynamic_cast<Chapter8*>(scene))
		{
			...
			{
			case 0:
				ObjectInfo = chpt8->MapInfo8[MonsterY - 1][MonsterX];
				break;
			case 1:
				ObjectInfo = chpt8->MapInfo8[MonsterY + 1][MonsterX];
				break;
			case 2:
				ObjectInfo = chpt8->MapInfo8[MonsterY][MonsterX - 1];
				break;
			case 3:
				ObjectInfo = chpt8->MapInfo8[MonsterY][MonsterX + 1];
				break;
